    ...
    >
      <div className="container mx-auto">
        <div className="max-w-2xl mx-auto text-center">
          <span className="label-chip label-chip-dark mb-6 inline-block">Get In Touch</span>

          <h2
            className="text-3xl sm:text-5xl font-bold mb-5 leading-[1.1]"
            style={{ fontFamily: "var(--font-heading)", letterSpacing: "-0.025em", color: "#0C1A38" }}
          >
          ...
          <p
            ...
            style={{ color: "rgba(12,26,56,0.65)" }}
          >
