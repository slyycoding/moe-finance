...
export function LendersSection() {
  return (
    <div className="py-14 sm:py-16" style={{ backgroundColor: "#F8F7F4" }}>
      <div className="container mx-auto px-4 sm:px-6">
        <p className="text-center text-xs font-semibold uppercase tracking-widest mb-8" style={{ color: "#9CA3AF" }}>
        ...
        >
          {lenders.map(({ name, svg }) => (
            <li
              key={name}
              className="flex items-center justify-center p-2 rounded-lg transition-all duration-300 cursor-default"
