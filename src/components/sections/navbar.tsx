    ...
    <>
      ...
      >
        <motion.div
          ...
          style={{ backgroundColor: bgOpacity.get() ? `rgba(8,13,24,${bgOpacity.get()})` : "transparent", borderBottom: `1px solid ${borderColor.get()}` }}
        />

        <div className="relative container mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between">
          {/* Logo */}
          <a href="/" aria-label="Fast Lending Group — home" className="flex items-center gap-2.5 group flex-shrink-0">
            <div
              className="w-9 h-9 rounded-xl flex items-center justify-center transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(224,93,56,0.5)]"
            ...
            <div className="hidden xs:block sm:block">
              ...
              <p className="text-orange-400/60 text-[10px] tracking-[0.25em] uppercase leading-tight">Fast Lending Group</p>
            </div>
          </a>
          ...
          <div className="hidden md:flex">
            <a
              ...
              className="btn-shine relative overflow-hidden inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full text-white font-semibold text-sm transition-all duration-300 group"
      ...
      {mobileOpen && (
        <div
          ...
          style={{ background: "rgba(8,13,24,0.98)", backdropFilter: "blur(24px)" }}
        >
