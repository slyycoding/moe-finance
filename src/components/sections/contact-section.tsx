              ...
              {contactDetails.map(({ icon: Icon, label, value, href }) => (
                <div key={label} className="flex items-start gap-3">
                  <div
                    ...
                    aria-hidden
                  >
                    <Icon className="w-4 h-4" style={{ color: "#141A5D" }} strokeWidth={1.75} />
                  </div>
                  <div>
                    <p className="text-xs uppercase tracking-widest mb-0.5" style={{ color: "#94A3B8" }}>
                      {label}
                    </p>
                    {href ? (
                      <a
                      ...
                      <p className="font-medium text-sm" style={{ color: "#334155" }}>{value}</p>
                    )}
                  </div>
                </div>
              ))}
                ...
                >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={fieldStyle}
                      onFocus={e => (e.currentTarget.style.borderColor = "#141A5D")}
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#F4C542", color: "#141A5D", minHeight: "52px" }}
                    onMouseEnter={e => { if (status !== "submitting") e.currentTarget.style.backgroundColor = "#E0B030"; }}
                    onMouseLeave={e => (e.currentTarget.style.backgroundColor = "#F4C542")}
                  >
